...
# todays_message <- paste0(", happy ", weekdays(Sys.time() + 60 * 60 * dynamic_UTC_offset()), "! Good day to you. Are you well enough to talk right now?")

todays_message <- paste0(", great ", weekdays(Sys.time() + 60 * 60 * dynamic_UTC_offset()), "! How are you today?")
...
if( args[2] == "ok" ) {
  ...
  if( args[3] == "visit_everyone_all_body_within_last_week" ) {
    ...
    result_close <- tryCatch({ 
      ...
      # lately ( just prev dates - SOME not visit) ( currently also includes: face_color = "white" )
      ok_RETURN_visit <- okcupid_visit_looper_dev(curr_port = 4444, browser = "chrome", use_the_custom_profile = FALSE, site_login = "time861wiz", site_password = "yourpas", age_range_str = "18:49", todays_message = todays_message, action = "just_visit", online_when = "within_the_last_week", not_to_vst = "SOME", not_to_msg = "NONE", face_color = "white", loop_forever = "no")
  ...
  if( args[3] == "message_everyone_all_body_online_now" ) {
    ...
    result_close <- tryCatch({ 
      ...
      # messaging - not previous dates ( currently also includes: face_color = "white" )
      ok_RETURN_message <- okcupid_visit_looper_dev(curr_port = 4444, browser = "chrome", use_the_custom_profile = FALSE, site_login = "time861wiz", site_password = "yourpas", age_range_str = "18:49", todays_message = todays_message, action = "message_greet_matchname", online_when = "online_now", not_to_vst = "NONE", not_to_msg = "all_all", face_color = "white", loop_forever = "no")  
...
if( args[2] == "pof" ) {
  ...
  if( args[3] == "visit_everyone_all_body_within_last_week" ) {
    ...
    result_close <- tryCatch({ 
      ...
      pof_RETURN_visit <- pof_visit_looper_dev(curr_port = 4444, browser = "chrome", use_the_custom_profile = FALSE, site_login = "era674smartest01", site_password = "yourpas", age_range_str = "23:44", todays_message = todays_message, action = "just_visit", online_when = "within_the_last_week", not_to_vst = "NONE", not_to_msg = "NONE", body_type = "anything", face_color = "white", loop_forever = "no") # default
  ...
  if( args[3] == "message_everyone_thin_athletic_online_now_T_online_today_ONLY" ) {
    ...
    result_close <- tryCatch({ 
      ...
      pof_RETURN_message_01 <- pof_visit_looper_dev(curr_port = 4444, browser = "chrome", use_the_custom_profile = FALSE, site_login = "era674smartest01", site_password = "yourpas", age_range_str = "23:44", todays_message = todays_message, action = "message_greet_matchname", online_when = "online_now", not_to_vst = "NONE", not_to_msg = "all_all", body_type = "thin_athletic", face_color = "white", loop_forever = "no")
    ...
    result_close <- tryCatch({ 
      ...
      pof_RETURN_message_02 <- pof_visit_looper_dev(curr_port = 4444, browser = "chrome", use_the_custom_profile = FALSE, site_login = "era674smartest01", site_password = "yourpas", age_range_str = "23:44", todays_message = todays_message, action = "message_greet_matchname", online_when = "online_today_ONLY", not_to_vst = "NONE", not_to_msg = "all_all", body_type = "thin_athletic", face_color = "white", loop_forever = "no")
  ...
  if( args[3] == "visit_everyone_thin_atheltic_within_last_week" ) {
    ...
    if(length(args) == 4) {
      ...
      result_close <- tryCatch({ 
        ...
        zk_RETURN_visit <- zk_visit_looper_dev(curr_port = 4444, browser = "chrome", use_the_custom_profile = FALSE, site_login = "epoch536intel@gmail.com", site_password = "yourpas", age_range_str = run_age_now_vec_range_str, todays_message = todays_message, action = "just_visit", online_when = "within_the_last_week", not_to_vst = "NONE", not_to_msg = "all_all", body_type = "thin_athletic")
  ...
  if( args[3] == "message_everyone_thin_atheltic_within_last_week" ) {
    ...
    if(length(args) == 4) {
      ...
      result_close <- tryCatch({ 
        ...
        zk_RETURN_message <- zk_visit_looper_dev(curr_port = 4444, browser = "chrome", use_the_custom_profile = FALSE, site_login = "epoch536intel@gmail.com", site_password = "yourpas", age_range_str = run_age_now_vec_range_str, todays_message = todays_message, action = "message_greet_matchname", online_when = "within_the_last_week", not_to_vst = "NONE", not_to_msg = "all_all", body_type = "thin_athletic")
