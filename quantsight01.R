...
# # Quantstrat_IV(08_2013))(GuyYollin)_quantstrat(blotter).pdf
  ...
  quanstrat01_inner <- function() {
    ...
    # Set up instruments with FinancialInstruments package
    currency("USD")
    symbols = c("WILL5000IND") # indicator DRBLACBS is not as a 'tradable'
    ...
    initAcct("will5000ind_f_drblacbs", portfolios="will5000ind_f_drblacbs", initDate=initDate, initEq=100000)
    ...
    add.signal("will5000ind_f_drblacbs", name="sigCrossover",arguments = list(columns=c("DRBLACBS","SMA4"),relationship="gt"),label="DR.gt.SMA4")
